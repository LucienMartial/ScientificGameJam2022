...
const farmerGameOver = "Les agriculteurs sont en contradiction avec le consortium,  ils ne suivent pas les indications du consortium et mettent des pièges partout. Des espèces disparaissent de plus en plus. On retrouve beaucoup de cadavres d'animaux près des fermes. De plus les gens se plaignent de plus en plus de l'abondance grandissant de piège. Les blessés se comptent par milliers. C'est l'ère des mutilés.";

const researcherGameOver = "Les chercheurs sont en contradiction avec le consortium,  ils ne suivent pas les indications du consortium et décident de faire ce qu'ils veulent. Ils sabotent les chasseurs et les agriculteurs, on retrouve des feux près des fermes, des pièges à portée humaine sont retrouvés dans les bois.  Les expériences sur les animaux se comptent par milliers. C'est l'ère de la recherche.";
